...
import { log, state, CONST } from '../global-speed-controller/page-script-builder.js';
import { injectPageScript, sendCmd, setupUnsafeWindowFallback, startDirectPolling, fallbackApply } from '../global-speed-controller/injection-strategies.js';
import { showIndicator, applyAll, setupMenuCommands, addStyles, updateSetSpeedLabel } from '../global-speed-controller/ui-controller.js';
