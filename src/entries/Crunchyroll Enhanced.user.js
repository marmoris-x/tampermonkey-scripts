...
import { waitForElement, debounce } from '../shared/dom-utils.js';
import { scanCards } from '../crunchyroll-enhanced/scanner.js';
import { applyFilterAndSort } from '../crunchyroll-enhanced/filters.js';
import { buildSidebar, attachEvents, toggle, updateStatus, updateStats, resetFilters, saveFilters, loadSavedFilters } from '../crunchyroll-enhanced/ui-panel.js';
