...
(function () {
  ...
  function startClickMode(config) {
    ...
    TM.ui.createToast(config.hint + ' (Esc to cancel)', { type: 'info', duration: 3000 });
  ...
  CAM.startClickMode = startClickMode;
  CAM.stopClickMode = stopClickMode;
  Object.defineProperty(CAM, 'activeClickMode', {
    get: function () { return activeClickMode; },
    set: function (v) { activeClickMode = v; },
  });
})();
