...
//           resetFilters, saveFilters, loadSavedFilters, sidebarStylesCSS, bodyHTML, sortOptsHTML, toggle
// Consumers: Crunchyroll Enhanced (entry orchestrator)

import { createSidebar } from '../shared/ui-components.js';
import { saveSetting, loadSetting } from '../shared/storage-utils.js';
 ...
 * @returns {string}
 */
export function bodyHTML(showBadges) {
 ...
 * @returns {string}
 */
export function sortOptsHTML(empty) {
  return [
 ...
 */
export function buildSidebar(ctx, sidebarWidth) {
 ...
 * @param {object} ctx - Class instance
 */
export function attachEvents(ctx) {
  ctx._$('cr-close').addEventListener('click', function () { toggle(ctx, false); });
  ...
  ctx._$('cr-btn-copy').addEventListener('click', function () { exportVisible(ctx); });
 ...
 */
export function toggle(ctx, forceTo) {
 ...
 * @param {string} msg
 */
export function updateStatus(ctx, msg) {
 ...
 */
export function updateStats(ctx, visible, total, wd) {
 ...
 * @param {object} ctx - Class instance
 */
export async function loadSavedFilters(ctx) {
  try {
