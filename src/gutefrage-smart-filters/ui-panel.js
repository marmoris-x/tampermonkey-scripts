...
(function () {
  ...
  /**
   * Filter UI sidebar panel wrapping TM.ui.createSidebar.
    ...
    attachEventListeners() {
      ...
      if (navUnanswered) {
        navUnanswered.addEventListener('click', function () {
          GSF.navigateToDate('unbeantwortet');
        });
      }
      ...
      if (resetBtn) {
        resetBtn.addEventListener('click', function () {
            ...
            interactionFilters: Object.assign({}, GSF.DEFAULT_FILTERS.interactionFilters),
  ...
  window.__GSF__.SidebarPanel = SidebarPanel;
})();
