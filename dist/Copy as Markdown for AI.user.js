...
(function () {
  ...
  function buildFrontmatter(url, title, lang) {
    var safeTitle = (title || "Untitled").replace(/[\r\n\t]+/g, " ").replace(/\\/g, "\\\\").replace(/"/g, '\\"').trim();
  ...
  function createTurndown(opts) {
    ...
    if (opts.nolinks) {
      ...
      td.addRule("imgAltFallback", {
        ...
        replacement: function(content, node) {
          var _a, _b;
          var src = node.getAttribute("data-src") || node.getAttribute("data-lazy-src") || node.getAttribute("data-original") || node.getAttribute("src") || "";
          if (!src || src.startsWith("data:")) return "";
          var rawAlt = node.getAttribute("alt") || "";
          var alt = rawAlt && !/^https?:|^\/|^data:/.test(rawAlt) ? rawAlt : ((_b = (_a = src.split("/").pop()) == null ? void 0 : _a.split("?")[0]) == null ? void 0 : _b.split(".")[0]) || "image";
          return "![" + alt + "](" + src + ")";
        }
      });
      td.addRule("picture", {
        ...
        replacement: function(content, node) {
          ...
          if (!src || src.startsWith("data:")) return "";
          var alt = img.getAttribute("alt") || ((_b = (_a = src.split("/").pop()) == null ? void 0 : _a.split("?")[0]) == null ? void 0 : _b.split(".")[0]) || "image";
          return "![" + alt + "](" + src + ")";
        }
      });
      td.addRule("figure", {
        ...
        replacement: function(content, node) {
          ...
          var alt = img.getAttribute("alt") || captionText || ((_b = (_a = src.split("/").pop()) == null ? void 0 : _a.split("?")[0]) == null ? void 0 : _b.split(".")[0]) || "image";
          var imgMd = "![" + alt + "](" + src + ")";
          return captionText ? "\n\n" + imgMd + "\n*" + captionText + "*\n\n" : "\n\n" + imgMd + "\n\n";
        }
      });
    ...
    td.addRule("barePre", {
      ...
      replacement: function(content, node) {
        ...
        var fenceSize = Math.max(3, (code.match(/`{3,}/gm) || []).reduce(function(m, s) {
  ...
  async function fetchUrlAsMarkdown(url, opts) {
    try {
      var doc = await fetchPage(url, { timeout: 15e3 });
      ...
      var pageLang = doc.documentElement.getAttribute("lang") || void 0;
